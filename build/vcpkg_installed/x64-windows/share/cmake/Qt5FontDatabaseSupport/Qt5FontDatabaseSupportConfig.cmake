...
macro(_populate_FontDatabaseSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5FontDatabaseSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::FontDatabaseSupport)
    ...
    set(Qt5FontDatabaseSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FontDatabaseSupport_install_prefix}/include/qt5/QtFontDatabaseSupport/5.15.8"
        "${_qt5FontDatabaseSupport_install_prefix}/include/qt5/QtFontDatabaseSupport/5.15.8/QtFontDatabaseSupport"
    )
    ...
    if(EXISTS "${_qt5FontDatabaseSupport_install_prefix}/debug/lib/Qt5FontDatabaseSupportd.prl")
        _qt5_FontDatabaseSupport_process_prl_file(
            "${_qt5FontDatabaseSupport_install_prefix}/debug/lib/Qt5FontDatabaseSupportd.prl" DEBUG
            _Qt5FontDatabaseSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5FontDatabaseSupport_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5FontDatabaseSupport_install_prefix}/lib/Qt5FontDatabaseSupport.prl")
        _qt5_FontDatabaseSupport_process_prl_file(
    ...
    if (EXISTS "${_qt5FontDatabaseSupport_install_prefix}/debug/lib/Qt5FontDatabaseSupportd.lib" )
