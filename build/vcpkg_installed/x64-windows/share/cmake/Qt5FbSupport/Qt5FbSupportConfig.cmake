...
macro(_populate_FbSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5FbSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::FbSupport)
    ...
    set(Qt5FbSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5FbSupport_install_prefix}/include/qt5/QtFbSupport/5.15.8"
        "${_qt5FbSupport_install_prefix}/include/qt5/QtFbSupport/5.15.8/QtFbSupport"
    )
    ...
    if(EXISTS "${_qt5FbSupport_install_prefix}/debug/lib/Qt5FbSupportd.prl")
        _qt5_FbSupport_process_prl_file(
            "${_qt5FbSupport_install_prefix}/debug/lib/Qt5FbSupportd.prl" DEBUG
            _Qt5FbSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5FbSupport_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5FbSupport_install_prefix}/lib/Qt5FbSupport.prl")
        _qt5_FbSupport_process_prl_file(
    ...
    if (EXISTS "${_qt5FbSupport_install_prefix}/debug/lib/Qt5FbSupportd.lib" )
