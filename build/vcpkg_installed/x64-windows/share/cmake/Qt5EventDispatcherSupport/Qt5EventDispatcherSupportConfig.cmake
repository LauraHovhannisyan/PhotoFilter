...
macro(_populate_EventDispatcherSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5EventDispatcherSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::EventDispatcherSupport)
    ...
    set(Qt5EventDispatcherSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt5/QtEventDispatcherSupport/5.15.8"
        "${_qt5EventDispatcherSupport_install_prefix}/include/qt5/QtEventDispatcherSupport/5.15.8/QtEventDispatcherSupport"
    )
    ...
    if(EXISTS "${_qt5EventDispatcherSupport_install_prefix}/debug/lib/Qt5EventDispatcherSupportd.prl")
        _qt5_EventDispatcherSupport_process_prl_file(
            "${_qt5EventDispatcherSupport_install_prefix}/debug/lib/Qt5EventDispatcherSupportd.prl" DEBUG
            _Qt5EventDispatcherSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5EventDispatcherSupport_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5EventDispatcherSupport_install_prefix}/lib/Qt5EventDispatcherSupport.prl")
        _qt5_EventDispatcherSupport_process_prl_file(
    ...
    if (EXISTS "${_qt5EventDispatcherSupport_install_prefix}/debug/lib/Qt5EventDispatcherSupportd.lib" )
