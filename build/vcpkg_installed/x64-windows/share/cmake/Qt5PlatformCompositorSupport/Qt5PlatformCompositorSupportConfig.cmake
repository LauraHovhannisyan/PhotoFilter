...
macro(_populate_PlatformCompositorSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5PlatformCompositorSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::PlatformCompositorSupport)
    ...
    set(Qt5PlatformCompositorSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt5/QtPlatformCompositorSupport/5.15.8"
        "${_qt5PlatformCompositorSupport_install_prefix}/include/qt5/QtPlatformCompositorSupport/5.15.8/QtPlatformCompositorSupport"
    )
    ...
    if(EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/debug/lib/Qt5PlatformCompositorSupportd.prl")
        _qt5_PlatformCompositorSupport_process_prl_file(
            "${_qt5PlatformCompositorSupport_install_prefix}/debug/lib/Qt5PlatformCompositorSupportd.prl" DEBUG
            _Qt5PlatformCompositorSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5PlatformCompositorSupport_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/lib/Qt5PlatformCompositorSupport.prl")
        _qt5_PlatformCompositorSupport_process_prl_file(
    ...
    if (EXISTS "${_qt5PlatformCompositorSupport_install_prefix}/debug/lib/Qt5PlatformCompositorSupportd.lib" )
