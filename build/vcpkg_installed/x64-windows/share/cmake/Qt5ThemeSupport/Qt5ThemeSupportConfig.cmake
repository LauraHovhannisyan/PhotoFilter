...
macro(_populate_ThemeSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5ThemeSupport_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::ThemeSupport)
    ...
    set(Qt5ThemeSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5ThemeSupport_install_prefix}/include/qt5/QtThemeSupport/5.15.8"
        "${_qt5ThemeSupport_install_prefix}/include/qt5/QtThemeSupport/5.15.8/QtThemeSupport"
    )
    ...
    if(EXISTS "${_qt5ThemeSupport_install_prefix}/debug/lib/Qt5ThemeSupportd.prl")
        _qt5_ThemeSupport_process_prl_file(
            "${_qt5ThemeSupport_install_prefix}/debug/lib/Qt5ThemeSupportd.prl" DEBUG
            _Qt5ThemeSupport_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5ThemeSupport_STATIC_DEBUG_LINK_FLAGS
        )
    endif()

    if(EXISTS "${_qt5ThemeSupport_install_prefix}/lib/Qt5ThemeSupport.prl")
        _qt5_ThemeSupport_process_prl_file(
    ...
    if (EXISTS "${_qt5ThemeSupport_install_prefix}/debug/lib/Qt5ThemeSupportd.lib" )
